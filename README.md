...
**الجلسة 2 — حلقة الاستخدام اليومي:** الجدولة بأنظمتها الثلاثة (يدوي/مساعد/تلقائي
مع محرّك ترجيح)، توليد قائمة اليوم + حالة المهمة الثلاثية + المتراكم، البومودورو
المربوط بالمهمة، صندوق الشكوك الملاصق + الملخّص القابل للطباعة، وضع العد التنازلي
مع ترتيب الوحدات بالأضعف، والتكرار المتباعد التلقائي عند إتمام الدرس. كلها
local-first (تشتغل بدون إنترنت من Dexie، وتتزامن بالخلفية).

> ملاحظة تطوير: المصادقة والمزامنة تحتاج وصولاً مباشراً لـ Supabase. بعض البيئات
> المعزولة تحجب هذا الوصول بسياسة الشبكة؛ التطبيق يعمل طبيعياً محلياً وعلى Vercel.
