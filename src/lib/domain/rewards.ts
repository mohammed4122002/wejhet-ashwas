...
/**
 * مدن فلسطين الرئيسية لقالب الخارطة (كل مدينة شريحة % من التقدّم العام).
 *
 * الترتيب = ترتيب الإنارة: يبدأ النور من القدس (القلب) ثم ينتشر خارجاً نحو
 * أطراف البلاد حسب البُعد الجغرافي الفعلي عن القدس — لتبدو الخارطة وكأنها
 * تُضاء انطلاقاً من مركزها شيئاً فشيئاً حتى تعمّ من رفح جنوباً إلى صفد شمالاً.
 */
